...
class Spring(System):
    ...
    def make_observation(self, observation_length=4):
        ...
        index = random.randint(0, len(trajectory.positions)-observation_length)
        observations = trajectory.positions.iloc[index:index+observation_length]
        return observations
...
if __name__ == '__main__':
    ...
    dynamics = ['static_graph', 'periodic_graph']
    generate_data(args=args, dynamics=dynamics[0])
